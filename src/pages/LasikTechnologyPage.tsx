...
const techGenerations = [
  ...
  {
    era: "5th Generation (2024–Present)",
    name: "Advanced Lenticule Extraction (SiLK / SILK)",
    description: "J&J Vision's elita™ platform represents the latest evolution — combining lenticule extraction with an optimized laser pattern for ultra-smooth stromal beds. SiLK achieves sub-2mm incisions with 500 Hz laser speed, delivering the best night vision and contrast sensitivity outcomes. This is the most advanced commercially available refractive surgery technology.",
