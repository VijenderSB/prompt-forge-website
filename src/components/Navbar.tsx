...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-card/95 backdrop-blur-xl border-b border-border">
      <div className="container grid grid-cols-3 lg:flex lg:items-center lg:justify-between h-[clamp(72px,16vw,96px)] lg:h-[88px] items-center">
        <Link to="/" className="flex items-center gap-2 col-start-2 justify-self-center lg:col-auto lg:justify-self-auto" aria-label={BRAND.name}>
          <img src={logo} alt={`${BRAND.name} logo`} className="h-[clamp(48px,12vw,72px)] lg:h-[64px] w-auto object-contain" />
        </Link>
